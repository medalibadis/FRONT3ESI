      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="p-6 flex justify-between items-center">
          <div>
            ...
            <h1 className="text-[#0f172a] text-2xl font-bold">Welcome to Dashboard !</h1>
          </div>
          <div className="flex items-center gap-2">
            <div className="relative">
              <button className="flex items-center gap-2 text-[#2185d5] font-medium">
                <Bell className="text-[#2185d5]" size={20} />
                <span>Notifications</span>
                <ChevronDown size={16} className="text-[#2185d5]" />
              </button>
            </div>
          </div>
        </header>
            ...
            <StatCard
              icon={
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M3 6.5H8.5V12" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path
                    d="M15.5 12V17.5H21"
                    stroke="white"
                    strokeWidth="2"
