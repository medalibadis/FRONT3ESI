      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white p-6 flex justify-between items-center">
          <div>
            ...
            <h1 className="text-[#0f172a] text-2xl font-bold">Welcome to Settings!</h1>
          </div>
        ...
        <div className="flex-1 overflow-auto p-6 bg-[#f8fafc]">
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-[#1e293b] text-xl font-medium mb-6">Settings</h2>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 text-left text-sm text-gray-500">
                    ...
                    <th className="px-6 py-4 font-medium">Picture</th>
                ...
                <tbody>
                  <tr className="border-b border-gray-200">
                    ...
                    <td className="px-6 py-4 text-sm">aa.dennai@esi-sba.dz</td>
